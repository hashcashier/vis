...
\input{content/4.user.study}
\input{content/5.conclusion}
\input{content/6.future.work}
%
%
...
\appendix
\input{content/A.appendix}
\ifdeutsch
Alle URLs wurden zuletzt am 17.\,03.\,2008 geprüft.
\else
All links were last followed on March 10, 2015.
\fi
